...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthQuakes> extractEarthquakes(String earthQuakeJson) {
        ...
        try {
            ...
            if (featuresArray.length() > 0){
                for (int i = 0;i < featuresArray.length();i++){
                    ...
                    EarthQuakes earth = new EarthQuakes(magnitude, place, time, url);
    ...
    /**
     * Query the USGS dataset and return an {@link List<EarthQuakes>} object to represent a single earthquake.
     */
